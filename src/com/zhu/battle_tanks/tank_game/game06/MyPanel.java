...
public class MyPanel extends JPanel implements KeyListener, Runnable {
    ...
    public void showInfo(Graphics g) {
        ...
        g.setFont(font);
        g.drawString("您累积击毁敌方坦克数", 1020, 25);
        drawTank(1020, 65, g, 0, 0);//画出一个敌方坦克
        g.setColor(Color.BLACK);
        g.drawString(Recorder.getAllEnemyTankNum() + "", 1062, 100);
    }
        ...
        switch (tank.getDirection()) {
            ...
            case 2://坦克向下
                if (s.getX() > tank.getX() && s.getX() < tank.getX() + 40 &&
                    ...
                    //敌方坦克被击毁后调用add方法进行记录击毁的个数
                    //tank有可能是Hero，也有可能是EnemyTank，所以需要判断

...
public class MyPanel extends JPanel implements KeyListener, Runnable {
    ...
    public MyPanel() {
        ...
        //初始化图片对象
        image1 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/com/zhu/battle_tanks/tank_game/game05/bomb_1.gif"));
        image2 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/com/zhu/battle_tanks/tank_game/game05/bomb_2.gif"));
        image3 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/com/zhu/battle_tanks/tank_game/game05/bomb_3.gif"));
    }
